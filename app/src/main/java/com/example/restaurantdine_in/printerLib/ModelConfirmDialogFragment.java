...
public class ModelConfirmDialogFragment extends CommonAlertDialogFragment {
    ...
    public static ModelConfirmDialogFragment newInstance(String tag, int model) {
        ...
        args.putInt(PrinterSettingConstant.BUNDLE_KEY_MODEL_INDEX, model);
    ...
    Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String modelTitle = ModelCapability.getModelTitle(getArguments().getInt(PrinterSettingConstant.BUNDLE_KEY_MODEL_INDEX));
